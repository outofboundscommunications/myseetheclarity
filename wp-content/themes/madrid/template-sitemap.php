						    ...
						    <div class="<?php echo $midpage2 ?>">
						     <?php 
						      if(!isset($meta_values['meta_use_layout_builder'][0])){
						       ...
						       <div class="row-fluid">
						       						    	<div class="span3">
						       						    		<?php echo do_shortcode('[title title="'.__('Pages','code125').'" icon="icon-docs"]'); ?>
						       						    		<ul class="sitemap">
						       						    		<?php wp_list_pages('title_li='); ?>
						       						    		</ul>
						       						    	</div>
						       						    	<div class="span3">
						       						    		<?php echo do_shortcode('[title title="'.__('Categories','code125').'" icon="icon-tag"]'); ?>
						       						    		<ul class="sitemap">
						       						    		<?php wp_list_categories('title_li='); ?>
						       						    		</ul>
						       						    	</div>
						       						    	<div class="span3">
						       						    		<?php echo do_shortcode('[title title="'.__('Tags','code125').'" icon="icon-tags"]'); ?>
						       						    		<ul class="sitemap">
						       						    		<?php 
						       						    	...
						       						    	<div class="span3">
						       						    		<?php echo do_shortcode('[title title="'.__('Authors','code125').'" icon="icon-user"]'); ?>
						       						    		<ul class="sitemap">
						       						    		<?php wp_list_authors(); ?>
						       						    		</ul>
						       						    	</div>
