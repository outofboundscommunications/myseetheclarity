...
jQuery(function($)
    {
        function code125_check_item_categories()
        {
            $('[id*="wrap_meta_list_item_cat"]').hide();
 
            $('#item_typechecklist input[type="checkbox"]').each(function(i,e)
            {
                var id = $(this).attr('value');
                
                if ($(this).is(':checked')){
                    $('[id*="wrap_meta_list_item_cat'+id+'"]').show();
                }
            });
        }
 
        $('#item_typechecklist input[type="checkbox"]').live('click', code125_check_item_categories);
 
        code125_check_item_categories();
        
        
        function code125_check_categories()
               {
                   $('[id*="wrap_meta_list_cat"]').hide();
                   ...
                   $('#categorychecklist input[type="checkbox"]').each(function(i,e)
                   {
                       ...
                       if ($(this).is(':checked')){
                           $('[id*="wrap_meta_list_cat'+id+'"]').show();
                       }
                   });
               }
        
               $('#categorychecklist input[type="checkbox"]').live('click', code125_check_categories);
        
               code125_check_categories();
