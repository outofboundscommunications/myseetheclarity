...
ob_start();
the_excerpt_max_charlength(400);
...
$data = $data . '<div style="height:30px;"></div><div class="row-fluid"><div class="span3"><div class="style_4_wrap"><a class="author-photo clearfix" href="'.get_author_posts_url($user_ID).'">'.get_avatar( $user_ID, '100', '', '<span class="icon-user"></span>' ).'</a>';
...
$data = $data . '<a href="#" class="show-full-post roll-link-html btn-block" data-id="'.get_the_ID().'" data-type="'.$type.'" data-loading="'.__('Loading Article','code125').'" data-done="'.__('Load Article','code125').'"  data-close="'.__('Close Article','code125').'" ><span class="text ">'.__('Load Article','code125').'<span class="more-right icon-down-dir-1"></span></span><span class="hover ">'.__('Load Article','code125').'<span class="more-right icon-down-dir-1"></span></span></a>';
