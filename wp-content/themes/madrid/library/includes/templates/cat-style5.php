...
if($mutual_array['cat-counter'] == 1){
	...
	$data = $data . '<article class="blog-thumb style_cat clearfix"><div class=" margin-bottom-20"><a href="' . $permalink . '">'.$the_post_thumbnail.'</a><h2 class="clearfix blogtitle"><a class="title" href="' . $permalink . '">' . $the_title . '</a></h2>';
