...
if($mutual_array['cat-counter'] == 1){
	...
	$data = $data . '<div class="row-fluid"><div class="span6"><article class="blog-thumb style_cat clearfix"><a href="' . $permalink . '">'.$the_post_thumbnail.'</a><h2 class="clearfix blogtitle"><a class="title" href="' . $permalink . '">' . $the_title . '</a></h2>';
	...
	$data = $data . '<div class="clearfix"></div><p class="content-short"> ' . $the_excerpt_max_charlength . '</p></article></div><div class="span6">';
