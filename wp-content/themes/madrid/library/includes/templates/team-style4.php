...
$data = $data . '<div class="element portfolio_item_single '.$tax.'-'. $cat_id.' ' . $cat_echo . '" data-category="' . $cat_echo . '"><div class="image-wrap"><a href="' . $permalink . '">' . $the_post_thumbnail . '</a></div><hgroup class="data-title"><div class="alpha-div"></div><a class="title" href="' . $permalink . '" >' . get_the_title() . '</a><p class="portfolio-cats">' . $cats . '</p>'.$icons_code.'</hgroup></div>';
?>