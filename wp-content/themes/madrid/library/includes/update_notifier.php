...
function update_notifier_menu() {  
	...
	if(version_compare($theme_data['Version'], $xml->latest) == -1) {
		add_dashboard_page('Madrid Theme Updates','Madrid <span class="update-plugins count-1"><span class="update-count">New Updates</span></span>', 'administrator', 'madrid-updates', 'update_notifier');
	}
}  
...
function update_notifier() { 
	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px;">
            ...
            <p><strong>Please note:</strong> make a <strong>backup</strong> of the Theme inside your WordPress installation folder <strong>/wp-content/themes/madrid/</strong></p>
            ...
            <p>Extract the zip's contents, look for the extracted theme folder, and after you have all the new files upload them using FTP to the <strong>/wp-content/themes/madrid/</strong> folder overwriting the old ones (this is why it's important to backup any changes you've made to the theme files).</p>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://madrid.code-125.com/updates.xml';
