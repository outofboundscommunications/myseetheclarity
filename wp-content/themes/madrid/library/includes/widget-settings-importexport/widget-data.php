...
class Widget_Data {
	...
	public static function add_admin_menus() {
		...
		add_action( 'admin_enqueue_scripts', 'widget_import_enqueue');
		
		function widget_import_enqueue($hook){
			

			wp_enqueue_style( 'widget_data',get_template_directory_uri().'/library/includes/widget-settings-importexport/widget-data.css' );
			wp_enqueue_script( 'widget_data', get_template_directory_uri().'/library/includes/widget-settings-importexport/widget-data.js', array( 'jquery', 'wp-ajax-response' ) );	
