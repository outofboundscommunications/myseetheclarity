...
function appointments_address_func(){
	$result = '';
		...
		if ( $my_query->have_posts() ){
			...
			<div class="appointments_select_location_wrapper">
				<select name="select_location" class="appointments_select_location">
					<option value="" data-location_id="">Select your location</option>
					<?php
					$post_count = 0;
				...
				if( $post_count == 1 ){
					...
					<div class="address_detail">
						<div class="address_link">
							...
							?>
							<a style="background-color:#CACACA;" class="ea-btn-small" href="<?php echo $location_appointment_url;?>" target="_blank">book appointment</a><br />
						</div>
				...
				while ($my_query->have_posts()){
					...
					<div id="address_<?php echo get_the_ID();?>">
						<div class="address_link">
							...
							?>
							<a style="background-color:#CACACA;" class="ea-btn-small" href="<?php echo $location_appointment_url2;?>">book appointments</a>
						</div>
						<div class="address_title">
							<h2>
								<?php
