					...
					<div id="address_<?php echo get_the_ID();?>">
						...
						<div class="address_contacts">
							...
							<?php $location_phone_number2 = get_field('location_phone_number');?>
								<span class="address_contacts_data">
									<a href="tel:<?php echo $location_phone_number2;?>"><?php echo $location_phone_number2;?></a>
								</span>
							</span>
							<span class="address_contacts_fax">
								<span class="address_contacts_label">Fax:</span>
...
add_shortcode('cf7_thanks', 'cf7_thanks_func');
function cf7_thanks_func($atts, $content = "")
{
	...
	if( isset($_POST)  && !empty($_POST) )
	{
		...
		$new_msg = 'Thank you, '.$_POST['fn'].' for taking the time to apply to the '.$_POST['position'].' position. <br/>If you experince, skills and interests meet the qualifications of the position, we will contact you to further discuss your application.';
